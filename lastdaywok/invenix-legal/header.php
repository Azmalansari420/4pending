       ...
       <header class="header-area style-5">
        <div class="nav-left">
            <div class="header-logo">
                <a href="index.php"><img alt="image" src="assets/logo.png"></a>
            </div>
            <div class="main-nav">
                <div class="mobile-logo-area d-xl-none d-flex justify-content-between align-items-center">
                    <div class="mobile-logo-wrap ">
                        <a href="index.php"><img alt="image" src="assets/logo.png" width="100px"></a>
                    </div>
                ...
                <ul class="menu-list">
                    ...
                    <li><a href="index.php#testimonial">Client Reviews</a></li>
                    
                </ul>
                <!-- mobile-search-area -->
                <div class="d-xl-none d-block">
                    <div class="eg-btn btn--primary btn--lg d-xl-none d-flex">
                        <a data-bs-toggle="modal" data-bs-target="#myModal"><i class="bi bi-dash-lg"></i>Get Enquiry</a>
                    </div>
                </div>
            ...
            <a data-bs-toggle="modal" data-bs-target="#myModal" class="eg-btn btn--primary2 sibling2  btn--lg2 d-xxl-flex d-none"><i class="bi bi-dash-lg"></i>Get Enquiry  </a>
        </div>
