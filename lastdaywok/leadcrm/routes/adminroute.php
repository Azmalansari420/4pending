...
use App\Http\Controllers\admin_con\Role;
use App\Http\Controllers\admin_con\Tbl_admin;
...
Route::prefix('admin/role')->group(function () {
    Route::get('/', [Role::class, 'listing'])->name('admin/role/list');
    Route::post('/table', [Role::class, 'getTableData'])->name('admin/role/table');
    /*------add------*/
    Route::get('/add', [Role::class, 'add_page_url'])->name('admin/role/add');
    /*------upadte------*/
    Route::get('/edit/{id}', [Role::class, 'edit_page_url'])->name('admin/role/edit');
    /*----view----*/
    Route::get('/view/{id}', [Role::class, 'view_page_url'])->name('admin/role/view');
    /*--single update -delete--*/
    Route::post('/store', [Role::class, 'storeOrUpdate'])->name('admin_con/role/storeOrUpdate');
    /*------status------*/
    Route::post('/update_status', [Role::class, 'updateStatus'])->name('admin/role/update_status');
    /*------delete------*/
    Route::delete('/delete_data/{id}', [Role::class, 'delete_data'])->name('admin_con/role/delete_data');
    Route::delete('/multiple_delete_data', [Role::class, 'multiple_delete_data'])->name('admin_con/role/multiple_delete_data');
});

/*------------------------tbl_admin----------------------*/
Route::prefix('admin/tbl_admin')->group(function () {
    Route::get('/', [Tbl_admin::class, 'listing'])->name('admin/tbl_admin/list');
    Route::post('/table', [Tbl_admin::class, 'getTableData'])->name('admin/tbl_admin/table');
    /*------add------*/
    Route::get('/add', [Tbl_admin::class, 'add_page_url'])->name('admin/tbl_admin/add');
    /*------upadte------*/
    Route::get('/edit/{id}', [Tbl_admin::class, 'edit_page_url'])->name('admin/tbl_admin/edit');
    /*----view----*/
    Route::get('/view/{id}', [Tbl_admin::class, 'view_page_url'])->name('admin/tbl_admin/view');
    /*--single update -delete--*/
    Route::post('/store', [Tbl_admin::class, 'storeOrUpdate'])->name('admin_con/tbl_admin/storeOrUpdate');
    /*------status------*/
    Route::post('/update_status', [Tbl_admin::class, 'updateStatus'])->name('admin/tbl_admin/update_status');
    /*------delete------*/
    Route::delete('/delete_data/{id}', [Tbl_admin::class, 'delete_data'])->name('admin_con/tbl_admin/delete_data');
    Route::delete('/multiple_delete_data', [Tbl_admin::class, 'multiple_delete_data'])->name('admin_con/tbl_admin/multiple_delete_data');
});
