            ...
            <div class="row">
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="pq-contact-grid-box">
                        ...
                        <p class="pq-contact-box-description">info@peacefulthemes.com<br>info2@peacefulthemes.com</p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6 mt-4 mt-md-0">
                    <div class="pq-contact-grid-box active">
                        ...
                        <p class="pq-contact-box-description">Phone No : + (567) 1234-567-8900<br>Phone No : + (567) 1234-567-8901</p>
                    </div>
                </div>
                <div class="col-xl-4 mt-4 mt-xl-0">
                    <div class="pq-contact-grid-box">
                        ...
                        <p class="pq-contact-box-description">The Queen's Walk, Bishop's, London SE1<br> 7PB, United Kingdom</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6 pe-xl-5">
                    <div class="pq-section-title pq-style-1 pq-mb-30">
                        ...
                        <h5 class="pq-section-main-title">Contact Us &amp; Get In here Touch !</h5>
                        <p class="pq-section-description">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration some form, by injected humour.</p>
                    </div>
                    <div class="map">
