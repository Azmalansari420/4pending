                  ...
                  <div class="card m-b-15">
                     <div class="row card-body">
                        ...
                        <div class="col-6 form-group">
                           ...
                           <input type="number" class="form-control" name="duration_seconds" value="<?=$EDITDATA[0]->duration_seconds ?>">
                        </div>
                        
                        <div class="col-6 form-group">
                           <label>Stop bet seconds </label>
                           <input type="number" class="form-control" name="stop_bet_seconds" value="<?=$EDITDATA[0]->stop_bet_seconds ?>">
                        </div>
