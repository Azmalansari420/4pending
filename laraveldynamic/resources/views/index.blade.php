			...
			<div class="col-lg-12 padding_lr0">
				<div class="witr_ds_content_area witr_dsider_js_active simages_id5">
					...
					<div class="witr_ds_slider_content witr_slick_content">
						<div class=" witr_ds_content witr_slick_height text-left" style="background-image:url({{'public/media/uploads/slider/'.$data->image}});">
								...
								<div class="slider_btn">
									<div class="witr_btn_style">
										<div class="witr_btn_sinner">
											<a class="witr_btn" href="{{$data->url ?? '#'}}">More Info +</a>
										</div>
									</div>
								</div>							
							</div>
			...
			<div class="col-lg-12">
				...
				<div class="witr_button_area text-center">
					<div class="witr_btn_style mr">
						<div class="witr_btn_sinner">	
							<a href="{{url('contact')}}" class="witr_btn">
			...
			<div class="col-lg-12">	
				...
				<div class="imagess_area wittr_car_top_left brand_bg">
					<div class="witr_car_overlay brand_imagess_active">
						@php
						$partner = DB::Table('partner')->where('status',1)->get();
						@endphp
						@foreach($partner as $data)

						<div class="slide_items">
							<a href="#"><img src="{{url('public/media/uploads/partner/'.$data->image)}}" alt=""/></a>
						</div>
					@endforeach
             ...
             <div class="row tshover testomonial-slide carso_idtesti2">
				...
				<div class="witr_item_column guttergs">
					<div class="test-part mt-50 witr_testi_s_11">
						...
						<p>{{$data->content}}</p>
						<h6>{{$data->name}}</h6>  									 
						<img src="{{url('public/media/uploads/testimonials/'.$data->image)}}" alt=""> 								
					</div>	
				</div>	
